 ...
 <!-- 4 Filtres par catégorie-->
   ...
   <!-- 4 Filtres par prix -->
    ...
    <Transition name="notification">
      <div 
        v-if="notifications.favorite.show" 
        class="notification"
      >
        <i :class="notifications.favorite.icon"></i>
        {{ notifications.favorite.message }}
      </div>
    </Transition>

    <Transition name="notification">
      <div 
        v-if="notifications.cart.show" 
        class="notification"
      >
        <i class="fas fa-shopping-cart"></i>
        {{ notifications.cart.message }}
      </div>
    </Transition>
...
const showNotification = (type, data) => {
  ...
  setTimeout(() => {
    notifications.value[type].show = false
  }, 3000)
}
...
const handleFavoriteClick = (product) => {
  ...
  showNotification('favorite', {
    icon: isFavorite ? 'fas fa-heart-broken' : 'fas fa-heart',
    message: isFavorite ? 'Article retiré des favoris' : 'Article ajouté aux favoris'
  })
}
...
.notification i.fa-heart-broken {
  color: #c41e3a;
}
